...
const routes = [
  ...
  {
    path: "/register",
    component: () => import("../views/articles/ArticleRegistration.vue"),
    ...
    children: [
      {
        path: "profile",
        name: "myProfile",
        component: () => import("../views/user/mypage/MyProfile.vue"),
      },
      {
        path: "list",
        name: "myList",
        component: () => import("../views/user/mypage/MyList.vue"),
      },
      {
        path: "list/:id",
        name: "myListDetail",
        component: () => import("../views/user/mypage/MyListDetail"),
        props: true,
      },
      {
        path: "change-password",
        name: "changePassword",
        component: () => import("../views/user/mypage/ChangePassword"),
      },
    ],
  },
  {
